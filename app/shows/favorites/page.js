    ...
    return(
        <main className="flex flex-col justify-center items-center">
            ...
            {data.favorites.map(show => (
                <div key={show.id} className="w-full sm:w-[220px] bg-indigo-950 p-4 mt-10 border-solid border-white border-2 rounded-md shadow-md shadow-indigo-500/50 flex flex-col items-center gap-2">
                    <Image 
                        src={show.image}
                        alt={`${show.name} image`}
                        width={150}
